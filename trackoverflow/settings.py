"""
Django settings for trackoverflow project.
...
SECRET_KEY = '%vjp*nl5*qb#y(%t3c3=6p&6jj*&n)ujd2&+%u!a!h7itfm$uo'
...
ROOT_URLCONF = 'trackoverflow.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'trackoverflow/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [ # additional files
